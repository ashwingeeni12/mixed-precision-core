...
REM
REM Generated by Vivado on Sat Oct 04 09:55:26 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_top_gemm_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_top_gemm_vlog.prj -log xvlog.log
